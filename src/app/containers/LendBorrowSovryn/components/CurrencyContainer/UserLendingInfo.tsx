  ...
  return (
    <RowTable>
      <thead className="tw-text-sm tw-tracking-normal">
        <tr>
          <TableHeader>
            {t(translations.lending.rowTable.tableHeaders.apy)}
          </TableHeader>
          <TableHeader>
            {t(translations.lending.rowTable.tableHeaders.yourDeposit)}
          </TableHeader>
          <TableHeader>
            {t(translations.lending.rowTable.tableHeaders.myProfit)}
          </TableHeader>
          <TableHeader>
            {t(translations.lending.rowTable.tableHeaders.rewards)}
          </TableHeader>
        </tr>
      </thead>
