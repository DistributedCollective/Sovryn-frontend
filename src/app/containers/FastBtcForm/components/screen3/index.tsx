  ...
  return (
    <>
      <div className="tw-text-center">
        ...
        <div className="tw-flex tw-flex-row tw-justify-center tw-items-center tw-text-gray-6 tw-mt-2">
      ...
      {state.depositTx && (
        <>
          <div className="tw-mt-4">
            <div className="tw-font-bold tw-text-gray-6">{t(s.amount)}</div>
            <div>{state.depositTx?.value} BTC</div>
          </div>
          <div className="tw-mt-4">
            <div className="tw-font-bold tw-text-gray-6">{t(s.status)}</div>
