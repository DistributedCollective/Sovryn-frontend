          ...
          <StyledContent>
            {response !== 'success' && (
              <div>
                ...
                <div className="tw-grid tw-gap-8 tw--mx-4w-grid-cols-12 tw-mb-6 tw-mt-12">
            ...
            {response === 'success' && (
              <div>
                ...
                <div className="tw-grid tw-gap-8 tw--mx-4w-grid-cols-12 tw-mb-6 tw-mt-12 tw-justify-center">
