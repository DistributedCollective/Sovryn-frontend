...
export function TradingChart(props: ChartContainerProps) {
  const [hasCharts] = useState<boolean>(true);
  ...
  return (
    <div
      className={cn(
        'tw-w-full tw-h-full d-flex tw-rounded tw-items-center tw-justify-center tw-overflow-hidden tw-rounded tw-w-full',
        hasCharts && 'border',
      )}
    ...
    >
      <>
        <div
          ...
          className={cn('tv-chart-container', !hasCharts && 'd-none')}
        >
