...
const UserWallet: React.FC<UserWalletProps> = ({ address, className }) => {
  ...
  return (
    <div
      className={cn(
        'tw-absolute tw-top-4 tw-right-4 tw-left-4 md:tw-left-auto engage-wallet tw-w-full md:tw-w-auto tw-flex tw-justify-center tw-items-center tw-px-4 tw-justify-between tw-truncate',
        className,
      )}
    >
