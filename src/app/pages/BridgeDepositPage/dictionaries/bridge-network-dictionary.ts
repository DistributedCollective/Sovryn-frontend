...
export class BridgeNetworkDictionary {
  public static readonly networks = [
    ...
    new NetworkModel(
      ...
      bscIcon,
      'https://bsc-dataseed.binance.org', // TODO: switch RPC to 'https://bsc.sovryn.app/testnet'
      'https://bscscan.com',
      AppMode.MAINNET,
    ...
    new NetworkModel(
      ...
      CrossBridgeAsset.BNB,
      bscIcon,
      'https://data-seed-prebsc-1-s2.binance.org:8545', //TODO: switch RPC to 'https://bsc.sovryn.app/mainnet'
