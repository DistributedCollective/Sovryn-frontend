...
import { LimitOrder, pairList, TradingTypes } from 'app/pages/SpotTradingPage/types';
...
import { ClosePositionDialog } from 'app/pages/SpotTradingPage/components/ClosePositionDialog';
