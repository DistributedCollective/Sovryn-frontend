...
export const pairs = {
  ...
  [TradingPairType.BPRO_DLLR]: [Asset.BPRO, Asset.DLLR],
  ...
  [TradingPairType.SOV_DLLR]: [Asset.SOV, Asset.DLLR],
...
export class TradingPairDictionary {
  ...
  >([
    ...
    [
      TradingPairType.SOV_DLLR,
      new TradingPair(
        TradingPairType.SOV_DLLR,
        RenderTradingPairName({ asset1: Asset.SOV, asset2: Asset.DLLR }),
        'SOV/DLLR',
        Asset.DLLR,
        Asset.SOV,
        [Asset.SOV, Asset.DLLR],
        false,
        true,
        false,
        2,
    ...
    [
      TradingPairType.BPRO_DLLR,
      new TradingPair(
        TradingPairType.BPRO_DLLR,
        RenderTradingPairName({ asset1: Asset.BPRO, asset2: Asset.DLLR }),
        'BPRO/DLLR',
        Asset.DLLR,
        Asset.BPRO,
        [Asset.BPRO, Asset.DLLR],
      ),
    ],
  ]);
