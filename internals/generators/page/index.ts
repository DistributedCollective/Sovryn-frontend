  ...
  actions: (data: { [P in ContainerProptNames]: string }) => {
    ...
    if (data.wantSlice) {
      actions.push({
        ...
        templateFile: './page/slice.ts.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
        path: `${containerPath}/selectors.ts`,
        templateFile: './page/selectors.ts.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'add',
      ...
      actions.push({
        ...
        templateFile: './page/importContainerState.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'modify',
        ...
        templateFile: './page/appendRootState.hbs',
        abortOnFail: true,
      });
    }
    if (data.wantSaga) {
    ...
    if (data.wantLoadable) {
      actions.push({
        ...
        templateFile: './page/loadable.tsx.hbs',
        abortOnFail: true,
      });
    }
