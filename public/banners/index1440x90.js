...
// stage content:
(lib._1440x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(1274.3,45.25,1.258,1.2218,0,0,0,112.1,25.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(124).to({_off:false},0).to({x:395.8},26,cjs.Ease.circOut).wait(90));

	// logo_copy
	this.instance_2 = new lib.Tween3("synched",0);
	this.instance_2.setTransform(646.1,484.9,2.4005,2.3989,0,0,0,0.2,0.3);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:0.3,scaleX:2.4004,x:646.3,alpha:1},22).to({regY:0.2,scaleX:2.4005,y:484.65},16).to({regX:0.6,regY:0.6,scaleX:2.4001,scaleY:2.3928,x:647.05,y:484.5,alpha:0},21).to({_off:true},12).wait(169));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(94).to({_off:false},0).wait(1).to({regX:543.6,regY:5.3,x:1286.75,y:47.3},0).wait(1).to({x:1065.25},0).wait(1).to({x:921.7},0).wait(1).to({regX:192.8,regY:65.2,x:475.3,y:107.2},0).wait(1).to({regX:543.6,regY:5.3,x:766.25,y:47.3},0).wait(1).to({x:725.9},0).wait(1).to({x:699.2},0).wait(1).to({x:682.15},0).wait(1).to({x:672},0).wait(1).to({x:666.95},0).wait(1).to({regX:192.8,regY:65.2,x:314.7,y:107.2},0).wait(135));

	// white_bg
	this.instance_4 = new lib.whitebg_round();
	this.instance_4.setTransform(1669.35,53.15,1.4233,1.215,0,0,0,77.5,21.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(98).to({_off:false},0).wait(1).to({regX:25.4,regY:15.8,x:1471.85,y:46},0).wait(1).to({x:1348},0).wait(1).to({x:1223.7},0).wait(1).to({x:1098.95},0).wait(1).to({x:973.9},0).wait(1).to({x:848.55},0).wait(1).to({regX:77.5,regY:21.7,x:797.1,y:53.15},0).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(76).to({_off:false},0).to({x:111.25},16,cjs.Ease.quartOut).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(61).to({_off:false},0).to({x:73.8},13,cjs.Ease.quartOut).wait(166));
...
p.nominalBounds = new cjs.Rectangle(160.5,-274.7,1659.9,828.8);
// library properties:
lib.properties = {
