...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(113.825,-0.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(1,1,1).p("AriAAIXFAA");
	this.shape_1.setTransform(-24.5,-0.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.STROKELEFT, new cjs.Rectangle(-99.4,-3.5,285,5.8), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLBGQgGAAAAgFIAAiBQAAgFAGAAIAXAAQAGAAAAAFIAACBQAAAFgGAAg");
	this.shape.setTransform(340.225,-4.95);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgzBGQgGAAAAgFIAAiBQAAgFAGAAIBnAAQAGAAAAAFIAAAXQAAAFgGAAIhKAAIAAAVIAsAAQAGAAAAAGIAAASQAAAGgGAAIgsAAIAAAyQAAAFgGAAg");
	this.shape_1.setTransform(331.025,-4.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag1BGQgGAAAAgFIAAiBQAAgFAGAAIBrAAQAGAAAAAFIAAAXQAAAFgGAAIhNAAIAAAVIAuAAQAGAAAAAGIAAASQAAAGgGAAIguAAIAAAWIBNAAQAGAAAAAFIAAAXQAAAFgGAAg");
	this.shape_2.setTransform(317.275,-4.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ag+BGQgGAAAAgFIAAiBQAAgFAGAAIBUAAQAvAAAAA1IAAAjQAAAzgvAAgAghAlIAzAAQAIAAADgDQAFgFAAgLIAAgiQAAgMgEgEQgEgDgIgBIgzAAg");
	this.shape_3.setTransform(302.125,-4.95);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.defi, new cjs.Rectangle(292,-33,102,43.6), null);
...
// stage content:
(lib._290x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(230.85,70.3,0.4832,0.4828,0,0,0,113.4,22.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(92).to({_off:false},0).to({alpha:1},15).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(104).to({_off:false},0).to({x:68.9,y:75.75},20,cjs.Ease.circOut).wait(116));

	// logo_copy
	this.instance_2 = new lib.Tween3("synched",0);
	this.instance_2.setTransform(108.7,224.9,1.0017,0.9994,0,0,0,0.2,0.1);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},14).to({startPosition:0},13).to({alpha:0},6).wait(207));

	// has_arrived
	this.instance_3 = new lib.hasarrived();
	this.instance_3.setTransform(151.6,93.2,1,1,0,0,0,192.8,65.2);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(68).to({_off:false},0).to({x:-137.95},17,cjs.Ease.quartOut).wait(155));

	// white_bg
	this.instance_4 = new lib.whitebg_round();
	this.instance_4.setTransform(359.95,50.95,0.5953,0.5028,0,0,0,76,21.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(72).to({_off:false},0).to({x:126.9},15,cjs.Ease.cubicOut).wait(153));

	// For_bitcoin
	this.instance_5 = new lib.forbitcoin();
	this.instance_5.setTransform(1148.2,37.65,1,1,0,0,0,192.8,65.2);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(48).to({_off:false},0).to({x:915.15},14,cjs.Ease.quartOut).wait(178));

	// Defi
	this.instance_6 = new lib.defi();
	this.instance_6.setTransform(196.75,51.7,1,1,0,0,0,192.8,22.4);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(36).to({_off:false},0).to({x:-88.3,y:53.05},15,cjs.Ease.quartOut).wait(189));

	// pattern
	this.instance_7 = new lib.patternbg();
	this.instance_7.setTransform(355.3,130,1,1,0,0,0,433.8,317);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:434,regY:316.8,scaleX:1.1529,scaleY:1.1529,rotation:-4.9582,x:316,y:140.2},239).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-140.1,-221.8,985.8000000000001,769.5999999999999);
// library properties:
lib.properties = {
